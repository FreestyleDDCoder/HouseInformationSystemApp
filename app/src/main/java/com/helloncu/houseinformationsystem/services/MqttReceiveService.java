package com.helloncu.houseinformationsystem.services;
...
import com.helloncu.houseinformationsystem.activitys.MqttNotificationActivity;
import com.helloncu.houseinformationsystem.utils.MQTTMessageHandle;
import com.helloncu.houseinformationsystem.utils.NotificationUtils;
...
public class MqttReceiveService extends Service {
    ...
    //收到推送执行的方法
    private String temp = "";
    private SharedPreferences house_information_system;
    ...
    public void onCreate() {
        super.onCreate();
        house_information_system = getSharedPreferences("house_information_system", MODE_PRIVATE);
        temp = house_information_system.getString("mqtt_temp", "");
        ...
        connection.listener(new Listener() {
            ...
            public void onPublish(UTF8Buffer topic, Buffer msg, Runnable ack) {
                ...
                if (!body.equals(temp)) {
                    ...
                    temp = body;
                    //保存mqtt的消息
                    house_information_system.edit().putString("mqtt_temp", temp).apply();
                }
                ack.run();
            }
        });
    ...
    public void onDestroy() {
        super.onDestroy();
        //在服务销毁的时候保存mqtt的消息
        SharedPreferences.Editor mqtt_temp = house_information_system.edit();
